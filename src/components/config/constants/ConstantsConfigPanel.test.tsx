...
const config: Configuration = {
  ...
  stats: [
    { id: 'bonus', name: 'Bonus', description: '', formula: 'STR / const.bonus_divider' },
    // Names the *stat* member, not the constant — the walker keeps namespaces apart
    { id: 'plain', name: 'Plain', description: '', formula: 'STR * 2' },
  ],
  specialitySkills: [],
  combatSkills: [],
  materials: [],
  ...
  it('should follow a formula when the constant it names is renamed', () => {
    useConfigStore.setState({
      config: {
        ...
        stats: [
          { id: 'bonus', name: 'Bonus', description: '', formula: 'STR / const.bonus_scale' },
        ],
      },
    });
