...
describe('/play', () => {
  ...
  it('should carry no stock Tailwind palette classes', () => {
    ...
    const source = readFileSync(resolve(process.cwd(), 'src/client/routes/play/index.tsx'), 'utf8');
...
describe('/play/create', () => {
  ...
  it('should carry no stock Tailwind palette classes', () => {
    const source = readFileSync(
      resolve(process.cwd(), 'src/client/routes/play/create.tsx'),
      'utf8'
    );
...
describe('/play/character/$id', () => {
  ...
  it('should carry no stock Tailwind palette classes', () => {
    const source = readFileSync(
      resolve(process.cwd(), 'src/client/routes/play/character.$id.tsx'),
      'utf8'
    );
