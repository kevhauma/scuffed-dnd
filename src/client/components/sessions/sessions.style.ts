 ...
 * `auth/authSurfaces.style.ts` are: four files import these, and a `SessionsPanel.style.ts` that
...
/** One table's row: what it is on the left, what can be done to it on the right */
...
export const dmBadgeStyles = 'font-heading text-xs uppercase tracking-widest text-amber';

/** *You play at this one* — `royal`, matching the marker the browser home uses */
export const playerBadgeStyles = 'font-heading text-xs uppercase tracking-widest text-royal';
 ...
 */
export const archivedBadgeStyles = 'font-heading text-xs uppercase tracking-widest text-stone-400';
