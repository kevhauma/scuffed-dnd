 ...
 * picker, by decision.
 *
 * Import validates twice, deliberately: **structurally** through `shared/services/importExport.ts`,
 * which refuses to apply data that cannot be rendered, and then **referentially** through
...
import { ValidationError } from '#shared/services/importExport';
import type { Configuration } from '#shared/types/config';
import { downloadConfiguration, importConfigurationFromFile } from '../../../services/configFiles';
