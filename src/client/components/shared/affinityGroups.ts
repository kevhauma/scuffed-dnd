...
import { affinityFor } from '#shared/engine/calculators/pointBuy';
import type { Archetype, Stat, StatAffinity } from '#shared/types';
import { STAT_AFFINITIES } from '#shared/types';
