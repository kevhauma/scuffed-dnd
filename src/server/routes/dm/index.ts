 ...
 *
 * Fourteen writes a DM makes to a Character in their session and one read of what they have done,
 ...
 * of it.
 *
 * **TICKET-DM-02 added the last six** — the purse as a total and as a delta, and the four acts a
