...
- [ ] CombatSkillRoller — per-skill roll button, animated dice, result breakdown, session history *(plan §12.5 — Req 15.1-15.5, 21.1-21.5, 22.1-22.6)* — needs TICKET-ROLL-01; mounts into TICKET-CHAR-03's combat-skill section, which deliberately ships without the roll control
