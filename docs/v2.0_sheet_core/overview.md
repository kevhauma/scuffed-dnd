...
- [ ] [TICKET-FORM-06](./tickets/TICKET-FORM-06-error-chips-on-the-sheet.md) — Error chips on the character sheet (Concept 00 §7) — renders FORM-05; closes the v1.0 known bug's visible half
