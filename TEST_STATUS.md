...
_Last verified: 2026-09-01 (`npx vitest run`) at **TICKET-PAS-01 — passive abilities: the entity and
the handout**, the current count-setter at **3716**.
...
Split across **223 files**: `server` in node, everything else in happy-dom.
