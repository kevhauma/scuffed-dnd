...
_Last verified: 2026-09-01 (`npx vitest run`) at **TICKET-DM-02 — DM controls: inventory and
purse**, the current count-setter at **3808**. The checkpoints before it were
...
Split across **227 files**: `server` in node, everything else in happy-dom.
