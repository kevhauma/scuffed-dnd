...
_Last verified: 2026-09-01 (`npx vitest run`) at **TICKET-DM-03 — quick actions derived from the
ruleset, and the sheet sidebar**, the current count-setter at **3863**. The checkpoints before it were
