...
_Last verified: 2026-08-29 (`npx vitest run`) at **TICKET-INV-06 — the item builder and the
Backpack**, the current count-setter at **3448**.
...
Split across **201 files**: `server` in node, everything else in happy-dom.
