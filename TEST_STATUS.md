...
_Last verified: 2026-09-01 (`npx vitest run`) at **TICKET-LIVE-03 — presence, reconnect and
replay**, the current count-setter at **4183** across 251 files. The checkpoints before it were
...
Split across **251 files**: `server` in node, everything else in happy-dom.
