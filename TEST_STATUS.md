...
_Last verified: 2026-08-31 (`npx vitest run`) at **TICKET-SPL-03 — spell effect templating**, the
current count-setter at **3600**.
...
Split across **216 files**: `server` in node, everything else in happy-dom.
