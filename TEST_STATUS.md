...
_Last verified: 2026-08-29 (`npx vitest run`) at **TICKET-ITEM-01 — item templates target skills,
grouped into shops**, the current count-setter at **3379**.
...
Split across **199 files**: `server` in node, everything else in happy-dom.
